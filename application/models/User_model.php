...

{
	...
	public  function get_only_location_search_list(){
		$this->db->select('location_list.l_id,location_list.location_name')->from('location_list');
	...
	public  function get_location_search_list(){
		$this->db->select('location_list.l_id,CONCAT(location_list.location_name,", ",city_list.city_name,", ",countries_list.country_name) as address,countries_list.country_code,countries_list.num_code')->from('location_list');
		$this->db->join('city_list ', 'city_list.city_id = location_list.city_id', 'left');
		$this->db->join('countries_list ', 'countries_list.c_id = city_list.c_id', 'left');
		$this->db->where('location_list.l_status ',1);
		$this->db->order_by('location_list.l_id','desc');
	...
	public  function get_location_search_indivisual_list(){
		/*location*/
		$this->db->select('location_list.location_name as address,CONCAT(l_id,"_","location") AS l_id,countries_list.country_code,countries_list.num_code')->from('location_list');
		$this->db->join('city_list ', 'city_list.city_id = location_list.city_id', 'left');
		$this->db->join('countries_list ', 'countries_list.c_id = city_list.c_id', 'left');
		...
		$result1=$this->db->get()->result_array();
		/*city*/
		$this->db->select('city_list.city_name as address,CONCAT(city_id,"_","city") AS l_id,countries_list.country_code,countries_list.num_code')->from('city_list');
		$this->db->join('countries_list ', 'countries_list.c_id = city_list.c_id', 'left');
		$this->db->group_by('city_list.city_name');
		$this->db->where('city_list.c_status',1);
		$result2=$this->db->get()->result_array();
		/*country*/
		$this->db->select('countries_list.country_name as address,CONCAT(c_id,"_","country") AS l_id,countries_list.country_code,countries_list.num_code')->from('countries_list');
	...
	public  function get_location_wise_with_intitue($i_id,$location_id){
		$this->db->select('institute_list.i_id,institute_list.i_name,institute_list.i_logo,institute_list.i_address,institute_list.i_p_phone,institute_list.i_email_id,institute_list.i_founder,institute_list.i_s_phone,countries_list.country_name,countries_list.country_code,countries_list.num_code,city_list.city_name,location_list.location_name')->from('institute_list');
	...
	public  function get_user_subscribes_video_list($u_id){
		$this->db->select('course_list.course_id,video_list.video_id,video_list.i_id,video_list.v_title,video_list.video_file,video_list.org_video_file,video_list.t_name,video_list.course_content,course_list.c_name as coursename,video_list.training_mode,institute_list.i_name,institute_list.i_logo,institute_list.i_p_phone,institute_list.i_email_id,institute_list.i_founder,institute_list.i_s_phone,institute_list.i_address,institute_list.i_contact_person,CONCAT(location_list.location_name," ",city_list.city_name," ",countries_list.country_name) as address,countries_list.country_code,countries_list.num_code')->from('video_subscribe_list');
