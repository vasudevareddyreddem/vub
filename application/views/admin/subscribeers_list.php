		...
		<div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php if(isset($subscribeers_list) && count($subscribeers_list)>0){ ?>
					<tbody>
						<?php foreach($subscribeers_list as $list){ ?>
							<tr>
							  <td style="display:none;"><?php echo $list['v_s_id']; ?></td>
							  <?php if(isset($user_details['role_id']) && $user_details['role_id']!=2){ ?>
							  <td><?php echo $list['i_name']; ?></td>
							  <?php } ?>
							  <td><?php echo $list['v_title']; ?></td>
