			...
			<?php if(isset($lastest_institute_list) && count($lastest_institute_list)>0){ ?>
				<div class="col-md-4 col-xs-12 col-sm-12">
							...
							<div class="bg-primary pad-10">
							 ...
							 <div class="pad-20 list-style-none" >
								<marquee class="" align="top" behavior="scroll"  onmouseout="this.start();" onmouseover="this.stop();" direction="up" scrollamount="2" style="padding: 10px;height: 350px;overflow:hidden;">
