							 ...
							 <div class=" ">
								<div class="row ">
								      <div class="col-md-3 col-xs-12 text-center " >
										<img class="img-vertical-center img-responsive" src="dist/img/in1.png" alt="naresh">
								   </div>
								   <div class=" col-md-7  bod-left">
									  <div class="article-details">
										 <h4><a href="<?php echo base_url('institute/page'); ?>" target="_blank" style="color:#0062C4;"> Naresh i Technologies | Software Training - Online Training</a></h4>
										 
										 <h5><strong class="site-col-r">Courses:</strong> Php, Java, Web Desing</h5> 
						  ...
						  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bg-white no-padding">
							 <div class=" ">
								<div class="row ">
								   ...
								   <div class=" col-md-7  bod-left">
									  <div class="article-details">
										 <h4><a href="institute-page.php" target="_blank" style="color:#0062C4;"> Naresh i Technologies | Software Training - Online Training</a></h4>
							 ...
							 <div class="pad-20 list-style-none" >
								<marquee class="pubmed-articles" align="top" behavior="scroll" onmouseout="this.start();" onmouseover="this.stop();" direction="up" scrollamount="2" style="padding: 5px 0px 5px 0px;height: 200px;background: #f5f5f5;overflow:hidden;">
								   <ul>
									  ...
									  <div>
									  <img  class="logo-recent-side " src="dist/img/in1.png">
									  </div>
									  <div>
								   ...
								   <ul>
									  <li style="padding:0px 0px 0px 5px">
									  <div>
									  <img  class="logo-recent-side " src="dist/img/sathya_technolologies_Logo.png">
									  </div>
									  <div>
